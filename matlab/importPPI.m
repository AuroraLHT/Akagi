...
%
%    Workbook: C:\Users\macbook\Desktop\研究数据\个股\AutoMacro\PPI.xlsx
%    Worksheet: Sheet1
%
...
SlArea='B2:M';
A=size(xlsread('C:\Users\macbook\Desktop\研究数据\个股\AutoMacro\PPI.xlsx'));
SlArea=[SlArea,int2str(A(1)+1)];

%% Import the data, extracting spreadsheet dates in Excel serial date format
[~, ~, raw, dates] = xlsread('C:\Users\macbook\Desktop\研究数据\个股\AutoMacro\PPI.xlsx','Sheet1',SlArea,'',@convertSpreadsheetExcelDates);
